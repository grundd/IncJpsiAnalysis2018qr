...
void STARlight_OptimalRA()
{
    // read the input files
    for(Int_t iRA = 0; iRA < 13; iRA++){
        Double_t R_A = 6.6 + iRA*0.1;
        TString str_in = Form("Results/PtFitWithoutBkg/OptimalRA/coh_modRA_%.2f_chi2.txt", R_A);
        ifstream ifs;
    ...
    // Print the results
    c->Print("Results/STARlight/OptimalRA/fit_RA.pdf");
    c->Print("Results/STARlight/OptimalRA/fit_RA.png");
