void ESDs_MC_kCohPsi2sToMuPi_merge(const char *dir, Int_t stage=0)
{
...
// Set temporary compilation directory to current one
   ...
   TString outputFile;
   Bool_t merged = kTRUE;
   AliAnalysisManager *mgr = AliAnalysisAlien::LoadAnalysisManager("ESDs_MC_kCohPsi2sToMuPi.root");
   if (!mgr) {
