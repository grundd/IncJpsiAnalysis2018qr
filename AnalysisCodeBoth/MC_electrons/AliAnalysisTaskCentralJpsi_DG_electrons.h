...
#ifndef AliAnalysisTaskCentralJpsi_DG_electrons_H
#define AliAnalysisTaskCentralJpsi_DG_electrons_H
...
class AliAnalysisTaskCentralJpsi_DG_electrons : public AliAnalysisTaskSE 
{
    public:
                AliAnalysisTaskCentralJpsi_DG_electrons(); 
                AliAnalysisTaskCentralJpsi_DG_electrons(const char *name);
        virtual ~AliAnalysisTaskCentralJpsi_DG_electrons(); 
    ...
    private:
        ...
        AliAnalysisTaskCentralJpsi_DG_electrons(const AliAnalysisTaskCentralJpsi_DG_electrons&); // not implemented
        AliAnalysisTaskCentralJpsi_DG_electrons& operator=(const AliAnalysisTaskCentralJpsi_DG_electrons&); // not implemented

        ClassDef(AliAnalysisTaskCentralJpsi_DG_electrons, 2);
};
