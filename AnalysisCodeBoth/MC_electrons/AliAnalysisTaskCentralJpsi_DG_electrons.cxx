...
// My headers:
#include "AliAnalysisTaskCentralJpsi_DG_electrons.h"

ClassImp(AliAnalysisTaskCentralJpsi_DG_electrons) // classimp: necessary for root

using std::cout;
using std::endl;

AliAnalysisTaskCentralJpsi_DG_electrons::AliAnalysisTaskCentralJpsi_DG_electrons() : // initializer list
    AliAnalysisTaskSE(),
    fPIDResponse(0),
    fTrackCutsBit4(0),
    isMC(kFALSE),
...
AliAnalysisTaskCentralJpsi_DG_electrons::AliAnalysisTaskCentralJpsi_DG_electrons(const char* name) : // initializer list
...
//_____________________________________________________________________________
AliAnalysisTaskCentralJpsi_DG_electrons::~AliAnalysisTaskCentralJpsi_DG_electrons()
{
    // destructor
...
//_____________________________________________________________________________
void AliAnalysisTaskCentralJpsi_DG_electrons::UserCreateOutputObjects()
{
...
//_____________________________________________________________________________
void AliAnalysisTaskCentralJpsi_DG_electrons::UserExec(Option_t *)
{
    ...
    // Cut on trigger will be performed later (# 2)
...
//_____________________________________________________________________________
void AliAnalysisTaskCentralJpsi_DG_electrons::ReplayTriggersMC(AliVEvent *fEvent)
{
...
//_____________________________________________________________________________
void AliAnalysisTaskCentralJpsi_DG_electrons::RunMCGenLevel()
{
    ...
    for(Int_t imc = 0; imc < mc->GetNumberOfTracks(); imc++) {
        ...
        // kCohJpsiToElRad, kIncohJpsiToElRad, kTwoGammaToElMedium:
        // if mu+ or mu- without a mother assigned (STARlight) 
        if(TMath::Abs(mcPart->PdgCode()) == 11 && mcPart->GetMother() == -1){
            // add its 4-vector to vGen
            TParticlePDG *partGen = pdgdat->GetParticle(mcPart->PdgCode());
            vDecayProduct.SetXYZM(mcPart->Px(),mcPart->Py(), mcPart->Pz(),partGen->Mass());
            vGen += vDecayProduct;
...
//_____________________________________________________________________________
void AliAnalysisTaskCentralJpsi_DG_electrons::FillMCGenTree(TLorentzVector v)
{
    fPtGen      = v.Pt();
...
//_____________________________________________________________________________
void AliAnalysisTaskCentralJpsi_DG_electrons::SetCrossed(Int_t spd[4], TBits &crossed){ 
...
//_____________________________________________________________________________
Int_t AliAnalysisTaskCentralJpsi_DG_electrons::GetChipId(Int_t index, Int_t &chipId2, Bool_t debug){
    // from the macro by MB
...
//_____________________________________________________________________________
Bool_t AliAnalysisTaskCentralJpsi_DG_electrons::IsSTGFired(TBits bits, Int_t dphiMin, Int_t dphiMax, Bool_t tolerance){
    // from the macro by MB
...
//_____________________________________________________________________________
void AliAnalysisTaskCentralJpsi_DG_electrons::Terminate(Option_t *)
{
    // the end
